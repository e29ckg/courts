...
<div class="row">
        ...
        <div class="panel panel-info ">
            ...
            <div class="panel-body">   
                <?php foreach ($juds as $jud): ?>                     
                    <a href="http://10.37.64.1/scan_system/PDFServer/<?= $jud->black_number; ?>/<?= $jud->file_name; ?>" target="_blank"> 
    ...
    <div class="col-xs-12 col-md-4">
        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-body">   
                <?php foreach ($juds as $jud): ?>                     
                    <a href="http://10.37.64.1/scan_system/PDFServer/<?= $jud->black_number; ?>/<?= $jud->file_name; ?>" target="_blank"> <?= $jud->black_number; ?>.<?= $jud->file_name; ?> </a>   
                    <hr>
                <?php endforeach; ?>
                <div class="btn pull-right">
                    <a href="#" target="_blank">
